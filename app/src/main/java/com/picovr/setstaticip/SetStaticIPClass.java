...
public class SetStaticIPClass {
    private static final String TAG = "SetStaticIPClass";
    ...
    public void setIpAddress(final String SSID, String PASSWORD, final String ip, final String gateway,
                                    final String dns) {
